...
<body>
    ...
    <div class="fish-container">
        <div class="box-container-2 single-product">
            <div class="box">
                <img src="Acc 5.jpg" id="productImg">
                <div class="small-img-row">
                    
                    <div class="small-img-col">
                        <img src="Acc 5.jpg" alt="" class="small-img">
                    </div>
                    <div class="small-img-col">
                        <img src="acc5A.jpg" alt="" class="small-img">
                    </div>

                    <div class="small-img-col">
                        <img src="acc5B.jpg" alt="" class="small-img">
                    </div>  
                </div>
            </div>
            <div>
                <h4>Home / Accessories</h4>
                <h1> Floating Thermometer</h1>
                <h4>Rs.380</h4>
                <input type="number" value="1">
                <a href="cart.jsp" class="btn"> Add to cart</a>
                <h3>Products Details <i class="fa fa-indent"></i></h3><br>
                <p><b><ul>Floating Glass Thermometer<br>
                    Range of thermometer 0 ºC -40 ºC<br>
                    Reads °C and °F<br>
                    Mounting sucker included</b></ul><br>You want to take good care of your aquarium,then you have to know the real temperature of the water.This Excellent quality and reliability New Aquarium Thermometer is exactly what you need! Let this be helpful to well keep your fish.It is the good choice for aquatics</p>
            </div>
        </div>
    </div>
    <div class="fish-container">
