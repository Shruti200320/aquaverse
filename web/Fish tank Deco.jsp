...
<body>
    ...
    <div class="fish-container">
        <div class="box-container-2 single-product">
            <div class="box">
                <img src="Acc 4.jpg" id="productImg">
                <div class="small-img-row">
                    
                    <div class="small-img-col">
                        <img src="Acc 4.jpg" alt="" class="small-img">
                    </div>
                    <div class="small-img-col">
                        <img src="acc4A.jpg" alt="" class="small-img">
                    </div>

                    <div class="small-img-col">
                        <img src="acc4B.jpg" alt="" class="small-img">
                    </div>  
                </div>
            </div>
            <div>
                <h4>Home / Accessories</h4>
                <h1> Fish Tank Decoration</h1>
                <h4><em>Rs.249</em></h4>
                <input type="number" value="1">
                <a href="cart.jsp" class="btn"> Add to cart</a>
                <h3>Products Details <i class="fa fa-indent"></i></h3><br>
                <p>Essential hiding places for fish.<br>
                    Suitable for use in both freshwater and saltwater. Easy to use<br>
                    It's not only no harm to pet fish but also create a more natural environment for the fishes.<br>
                    <em>Product Dimention (LxHxW): 15x10x17.5cm <br>Product Weight: 285gm Material: Resin Package Contents:1 Piece.</em><br>Suitable for all water types without fading. Aquarium ornament Give a beautiful look for your aquarium or fish tank.<br>
                    Offers the natural environment feeling. Change your aquarium into a beautiful scenery.<br>
                    Unique design, vivid colors and realistic image.<br>
                    reate a natural living environment in your aquarium Provides shelter, hiding spots and entertainment venues for the fish.</p>
            </div>
        </div>
    </div>
    <div class="fish-container">
        ...
        <div class="box-container-2">
            ...
            <a href="White Stones Large.jsp">
                <div class="box">
                    <img src="Acc3.jpg">
                    <h4>White Stones Large</h4> 
                    <div class="rating">
                        <i class="fa fa-star"></i>
                        <i class="fa fa-star"></i>
                        <i class="fa fa-star"></i>
