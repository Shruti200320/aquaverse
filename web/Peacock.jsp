...
<body>
    ...
    <div class="fish-container">
        <div class="box-container-2 single-product">
            <div class="box">
                <img src="plant19.jpg" id="productImg">
                <div class="small-img-row">
                    
                    <div class="small-img-col">
                        <img src="plant19.jpg" alt="" class="small-img">
                    </div>
                    <div class="small-img-col">
                        <img src="plant19A.jpg" alt="" class="small-img">
                    </div>

                    <div class="small-img-col">
                        <img src="plant19B.jpg" alt="" class="small-img">
                    </div>
                    
                    <div class="small-img-col">
                        <img src="plant19C.jpg" alt="" class="small-img">
                    </div>
                </div>
            </div>
            <div>
                ...
                <p><em>Quantity: Small pouch/ 5*5 cms steel mesh<br>
                    Light requirement: Low & Medium<br>Plant positioning: On driftwoods, Rocks,floating etc.<br>CO2 requirement: Low & Medium<br> Plant difficulty level: Easy<br>
                    Plant Propagation: Cuttings</em><br>In India, we can sell this Peacock Moss aquatic plant via online delivery systems to any states including Andhra Pradesh, Arunachal Pradesh, Assam, Bihar, Chhattisgarh, Goa, Gujarat,etc.</p>
            </div>
        </div>
    </div>
    <div class="fish-container">
