...
<body>
    ...
    <div class="fish-container">
        <div class="box-container-2 single-product">
            <div class="box">
                <img src="fish35.jpeg" id="productImg">
                <div class="small-img-row">
                    <div class="small-img-col">
                        <img src="fish35.jpeg" alt="" class="small-img">
                    </div>
                    <div class="small-img-col">
                        <img src="fish36.jpg" alt="" class="small-img">
                    </div>
                    <div class="small-img-col">
                        <img src="fish37.jpg" alt="" class="small-img">
                    </div>

                    <div class="small-img-col">
                        <img src="fish38.jpg" alt="" class="small-img">
                    </div>
                </div>
            </div>
            <div>
                <h4>Home / fish</h4>
                <h1> Panda Corydoras </h1>
                <h4>Rs.295/piece</h4>
