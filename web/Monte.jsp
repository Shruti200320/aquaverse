...
<body>
    ...
    <div class="fish-container">
        <div class="box-container-2 single-product">
            <div class="box">
                <img src="plant15.jpeg" id="productImg">
                <div class="small-img-row">
                    
                    <div class="small-img-col">
                        <img src="plant15.jpeg" alt="" class="small-img">
                    </div>
                    <div class="small-img-col">
                        <img src="plant15A.jpg" alt="" class="small-img">
                    </div>

                    <div class="small-img-col">
                        <img src="plant15B.jpg" alt="" class="small-img">
                    </div>
                    
                    <div class="small-img-col">
                        <img src="plant15C.jpg" alt="" class="small-img">
                    </div>
                </div>
            </div>
            <div>
                ...
                <p>In India, we can sell this Monte Carlo aquatic plant via online delivery systems to many states including Andhra Pradesh, Arunachal Pradesh, Assam, Bihar, Chhattisgarh, Goa, Gujarat, Haryana, Himachal Pradesh, Jammu & Kashmir, Jharkhand, Karnataka, Kerala, Madhya Pradesh, Maharashtra, Manipur, Meghalaya,etc.<br><em>Quantity: Large pot (5 cm in dia) or a large patch of equivalent quantity<br>Origin: New Zealand<br>Plant positioning: Foreground<br>Light requirement: High<br>CO2 requirement: Medium-High<br>Plant difficulty level: Medium<br>Plant Propagation: Cuttings</em></p>
            </div>
        </div>
    </div>
    <div class="fish-container">
