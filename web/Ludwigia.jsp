...
<body>
    ...
    <div class="fish-container">
        <div class="box-container-2 single-product">
            <div class="box">
                <img src="plant10.jpeg" id="productImg">
                <div class="small-img-row">
                    
                    <div class="small-img-col">
                        <img src="plant10.jpeg" alt="" class="small-img">
                    </div>
                    <div class="small-img-col">
                        <img src="plant10A.jpg" alt="" class="small-img">
                    </div>

                    <div class="small-img-col">
                        <img src="plant10B.jpg" alt="" class="small-img">
                    </div>
                    
                    <div class="small-img-col">
                        <img src="plant10C.jpg" alt="" class="small-img">
                    </div>
                </div>
            </div>
            <div>
                <h4>Home / plant</h4>
                <h1> Ludwigia repens</h1>
                <h4>Rs.19/Piece</h4>
                <input type="number" value="1">
                <a href="cart.jsp" class="btn"> Add to cart</a>
                <h3>Products Details <i class="fa fa-indent"></i></h3><br>
                <p>In India, we can sell this Ludwigia repens aquatic plant via online delivery systems to any states including Andhra Pradesh, Arunachal Pradesh, Assam, Bihar, Chhattisgarh, Goa, Gujarat, Haryana, Himachal Pradesh, Jammu & Kashmir, Jharkhand, Karnataka, Kerala, Madhya Pradesh,etc.<b>Quantity:</b> 3 stems,<b>Origin:</b> North and Central America,<b>Plant positioning:</b> Background & midground,<b>Light requirement:</b> Medium, .5 Watts/L,<b>CO2requirement:</b> Low, 6-14 mg/L,<b>Plant difficulty level:</b> Easy,<b>Plant Propagation:</b> Stemcutting.</p>
            </div>
        </div>
    </div>
    <div class="fish-container">
