...
<body>
    ...
    <div class="fish-container">
        <div class="box-container-2 single-product">
            <div class="box">
                <img src="food 6.jpg" id="productImg">
                <div class="small-img-row">

                    <div class="small-img-col">
                        <img src="food 6.jpg" alt="" class="small-img">
                    </div>
                    <div class="small-img-col">
                        <img src="food6A.jpg" alt="" class="small-img">
                    </div>

                    <div class="small-img-col">
                        <img src="food6B.jpg" alt="" class="small-img">
                    </div>

                    <div class="small-img-col">
                        <img src="food6C.jpg" alt="" class="small-img">
                    </div>
                </div>
            </div>
            <div>
                <h4>Home / foods</h4>
                <h1> Hikari Marine</h1>
                <h4><em>Rs.599/(110 grams)</em></h4 type="number" value="1">
                <a href="cart.jsp" class="btn"> Add to cart</a>
                <h3>Products Details <i class="fa fa-indent"></i></h3><br>
                <p>Utilizing bio-technology we can provide your fish with a nutritional package that will have them
                    looking like they just came off the reef. You can expect those rich, brilliant colours you bought
                    your marine fish for. Excellent for fish larger than 10 cm (4 inches) in length. Es sponge-like in
                    water thereby improving the acceptance by most marine fishes. The sponge-like texture allows us to
                    eliminate any clouding of the water and the hesitation most marine fish have to accepting a hard,
                    pellet-type food. Easily digested by all marine animals, reduces excessive fish waste and the
                    associated water quality problems. Rich in stabilized vitamin c, promotes resistance to stress and
                    immunity to infectious disease.</p>
            </div>
        </div>
    </div>
    <div class="fish-container">
        ...
        <div class="box-container-2">
            ...
            <a href="Artemia flakes.jsp">
                <div class="box">
                    <img src="food1.jpg">
                    <h4> Artemia Flakes</h4>
                    <div class="rating">
                        <i class="fa fa-star"></i>
                        <i class="fa fa-star"></i>
                        <i class="fa fa-star"></i>
