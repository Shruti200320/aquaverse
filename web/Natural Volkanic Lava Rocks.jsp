...
<body>
    ...
    <div class="fish-container">
        <div class="box-container-2 single-product">
            <div class="box">
                <img src="Acc 7.jpg" id="productImg">
                <div class="small-img-row">
                    
                    <div class="small-img-col">
                        <img src="Acc 7.jpg" alt="" class="small-img">
                    </div>
                    <div class="small-img-col">
                        <img src="acc7A.jpg" alt="" class="small-img">
                    </div>

                    <div class="small-img-col">
                        <img src="acc7B.jpg" alt="" class="small-img">
                    </div>  
                </div>
            </div>
            <div>
                <h4>Home / Accessories</h4>
                <h1> Natural Volkanic Lava Rocks</h1>
                <h4><em>Rs.249/(500 grams) <b>Pack of 1</b></em></h4>
                <input type="number" value="1">
                <a href="cart.jsp" class="btn"> Add to cart</a>
                <h3>Products Details <i class="fa fa-indent"></i></h3><br>
                <p>The lava stones are natural and hence no two rocks will look similar. These stones serve as a decorative element while acting as natural cave option and are very rare.<b>These stones have porous and are light weight</b>. Moreover, it offers thermal insulation, heat preservation and sound absorption qualities with no radiation and pollution.<b>The natural lava rocks are perfectly apt to use as a decorative element for aquarium as it removes nitrates from water and also increases oxygen level in water</b>.It can also be used in fire pits and grills as it improves flame performance by allowing gas dispersion in all directions.<em>The rocks can additionally be used in Terrariums as Terrarium decoration and for miniature fairy garden.</em>The stones are reusable and do not decay or decomposed, making it suitable to use for both residential and commercial purpose.</p>
            </div>
        </div>
    </div>
    <div class="fish-container">
