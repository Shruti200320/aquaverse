...
<body>
    ...
    <div class="fish-container">
        <div class="box-container-2 single-product">
            <div class="box">
                <img src="food7.jpeg" id="productImg">
                <div class="small-img-row">

                    <div class="small-img-col">
                        <img src="food7.jpeg" alt="" class="small-img">
                    </div>
                    <div class="small-img-col">
                        <img src="food7A.jpg" alt="" class="small-img">
                    </div>

                    <div class="small-img-col">
                        <img src="food7B.jpg" alt="" class="small-img">
                    </div>

                    <div class="small-img-col">
                        <img src="food7C.jpg" alt="" class="small-img">
                    </div>
                </div>
            </div>
            <div>
                <h4>Home / foods</h4>
                <h1> Monia Culture/macrocopa</h1>
                <h4><em>Rs.49/packet</em></h4>
                <input type="number" value="1">
                <a href="cart.jsp" class="btn"> Add to cart</a>
                <h3>Products Details <i class="fa fa-indent"></i></h3><br>
                <p><b>NOTE- <em>THIS PRODUCT?S SALES IS CURRENTLY LIMITED TO THE REGION OF KERALA BANGLORE AND TAMIL
                            NADU.CUSTOMERS OUTSIDE THESE PLACES CAN ORDER AT THEIR</b> OWN RISK</em><br>Moina macrocopa
                    is one of the perfect live fish foods for your aquatic fishes and their fries alike. They can be
                    cultured in yeast, organic matters such as cow dung and so on. They consist of high protein that
                    contributes to faster fish growth. Once bought, you can create an endless quantity of this tiny
                    organism when provided right conditions.<br>
                    <em> This package contains 60ml of moina culture and its base water. Kindly transfer it to a larger
                        container to start your own culturing procedures</em>.
                </p>
            </div>
        </div>
    </div>
