...
<body>
    ...
    <div class="fish-container">
        <div class="box-container-2 single-product">
            <div class="box">
                <img src="Acc 6.jpg" id="productImg">
                <div class="small-img-row">
                    
                    <div class="small-img-col">
                        <img src="Acc 6.jpg" alt="" class="small-img">
                    </div>
                    <div class="small-img-col">
                        <img src="acc6A.jpg" alt="" class="small-img">
                    </div>

                    <div class="small-img-col">
                        <img src="acc6B.jpg" alt="" class="small-img">
                    </div>  
                </div>
            </div>
            <div>
                ...
                <p><b>Instructions for use:</b> connect the air pump to air stone or filter via air pipe. Plug into 220-240 volt power point. To prolong pump life, replace air stones regularly. Never allow pump to come in contact with water. Air pumps have to be kept at a height higher than the highest water level of the aquarium, to ensure that the water does not flow back into the air pump in case of electricity failure and not touching or abutting the aquarium to ensure that the vibration caused by the air pumps does not disturb the aquatic fishes. Important safeguard: disconnect all the plugs of the electrical aquarium appliances before putting hands into the water. We recommended that air pump and other electrical aquarium devices, should be connected to correct voltage and power supplies with ground fault circuit interrupters.<br><b> Power: 12 w <br>voltage: 220-240 v<br> frequency: 50/60 hz <br>output: 4×4 l/min <br>pressure: 0.02 Mpa</b></p>
            </div>
        </div>
    </div>
    <div class="fish-container">
