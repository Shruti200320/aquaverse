...
<body>
    ...
    <div class="fish-container">
        <div class="box-container-2 single-product">
            <div class="box">
                <img src="plant27.jpg" id="productImg">
                <div class="small-img-row">
                    
                    <div class="small-img-col">
                        <img src="plant27.jpg" alt="" class="small-img">
                    </div>
                    <div class="small-img-col">
                        <img src="plant27A.jpeg" alt="" class="small-img">
                    </div>

                    <div class="small-img-col">
                        <img src="plant27B.jpg" alt="" class="small-img">
                    </div>
                    
                    <div class="small-img-col">
                        <img src="plant27C.jpg" alt="" class="small-img">
                    </div>
                </div>
            </div>
            <div>
                <h4>Home / plant</h4>
                <h1> Sagittaria Subulata</h1>
                <h4>Rs.20/Pair</h4>
                <input type="number" value="1">
                <a href="cart.jsp" class="btn"> Add to cart</a>
                <h3>Products Details <i class="fa fa-indent"></i></h3><br>
                <p><b><em>Quantity: 3 plants<br>Origin: USA<br>Plant positioning: Foreground & Midground <br>Light requirement: Medium<br>CO2 requirement: Low & Medium<br>Plant difficulty level: Easy<br>Plant Propagation: Plantlets</em></b><br>In India, we can sell this Sagittaria subulata- dwarf sag aquatic plant via online delivery systems to any states including Andhra Pradesh, Arunachal Pradesh, Assam, Bihar, Chhattisgarh, Goa, Gujarat, Karnataka, Kerala, Madhya Pradesh, Maharashtra, Manipur, Meghalaya, Mizoram, Nagaland, Odisha (Orissa), Punjab, Rajasthan, Sikkim, Tamil Nadu, Telangana, Tripura, Uttar Pradesh, Uttarakhand, and  West Bengal,etc.</p>
            </div>
        </div>
    </div>
    <div class="fish-container">
