...
<body>
    ...
    <div class="fish-container">
        <div class="box-container-2 single-product">
            <div class="box">
                <img src="fish27.png" id="productImg">
                <div class="small-img-row">
                    <div class="small-img-col">
                        <img src="fish27.png" alt="" class="small-img">
                    </div>
                    <div class="small-img-col">
                        <img src="fish25.jpg" alt="" class="small-img">
                    </div>
                    <div class="small-img-col">
                        <img src="fish26.jpg" alt="" class="small-img">
                    </div>
                    

                    <div class="small-img-col">
                        <img src="fish28.jpg" alt="" class="small-img">
                    </div>
                </div>
            </div>
            <div>
