...
<body>
    ...
    <div class="fish-container">
        <div class="box-container-2 single-product">
            <div class="box">
                <img src="Acc1.jpg" id="productImg">
                <div class="small-img-row">
                    
                    <div class="small-img-col">
                        <img src="Acc1.jpg" alt="" class="small-img">
                    </div>
                    <div class="small-img-col">
                        <img src="acc1A.jpg" alt="" class="small-img">
                    </div>

                    <div class="small-img-col">
                        <img src="acc1B.jpg" alt="" class="small-img">
                    </div>  
                </div>
            </div>
            <div>
                ...
                <h4><em>Rs.189</em> (set of 10 pcs plants)</h4>
                <input type="number" value="1">
                <a href="cart.jsp" class="btn"> Add to cart</a>
                <h3>Products Details <i class="fa fa-indent"></i></h3><br>Product Dimensions: <em>5.1D x 5.1W x 10.2H Centimeters</em><br><br>
                <p><b>Aquarium decorations:</b> Set with <em>10 differents</em> species in package, it cn bring different feelings to you fishes,all the colours are <em>vibrant</em>and<em>vivid</em>,even in the water, thus can <em><b>BEAUTIFY YOUR AQUARIUM.</b></em><br><b>Safe Material:</b> This artificial aquatic plants are made up of safe Materials,it's About plastic wihtout and metal items,soft and do not affect the PH in the tank,and safe for fish,They won't be hurt or any algae problems.<br><b>Colour Splash:</b> With artificial plants, your Aquascaping options are endless.You can place any type or size of plants anywhere you desire in your aquarium.<br><b>Easy to Clean:</b> A simple wipe an algae pad,brush or spray with the shower head will remove algae and detritus of the aquatic plants.<br><b>Colorful And Bright:</b> This set of plants have differents colors,thus can beautify your aquarium and Aquarium Landscape.</p>
            </div>
        </div>
    </div>
    <div class="fish-container">
