...
<body>
    ...
    <div class="fish-container">
        <div class="box-container-2 single-product">
            <div class="box">
                <img src="fish3.jpg" id="productImg">
                <div class="small-img-row">
                    
                    <div class="small-img-col">
                        <img src="fish3.jpg" alt="" class="small-img">
                    </div>
                    <div class="small-img-col">
                        <img src="fish39.jpg" alt="" class="small-img">
                    </div>

                    <div class="small-img-col">
                        <img src="fish2.jpg" alt="" class="small-img">
                    </div>
                    
                    <div class="small-img-col">
                        <img src="fish4.jpg" alt="" class="small-img">
                    </div>
                </div>
            </div>
            <div>
                <h4>Home / fish</h4>
                <form class="propost" action="addtocart" method="post">
                    <input type="hidden" class="pname" id="pname" name="pname">
                    <input type="hidden" class="pprice" id="pprice" name="pprice">

                    <h1 id="productname"> Betta Fish</h1>
                <h4 id="productprice">Rs.500</h4>
                
                <div><input type="number" value="1">
                <button type="submit" class="atcbtn"> Add to cart</button></div>
                <h3>Products Details <i class="fa fa-indent"></i></h3><br>
                <p>The Betta, on average, is 7.5 centimeters in length. Its body shape is streamlined, allowing it to
                    slip smoothly and effortlessly through open water. The fish's body is covered with scales that
                    overlap each other like the shingles on the roof of a house. These scales consist of thin,
                    transparent plates that help protect the Betta's body from injury and add streamlining for efficient
                    gliding.</p>
                </form>
    ...
    <script>
        ...
        let ppriceinput = document.querySelector('#pprice');
        
        let productname = document.querySelector('#productname');
        let productprice = document.querySelector('#productprice');
        var price = parseFloat(productprice.innerText.replace('Rs.',''));
        pnameinput.value=productname.innerText;
        ppriceinput.value=price;
        
        console.log(pnameinput.value);
        console.log(ppriceinput.value);
