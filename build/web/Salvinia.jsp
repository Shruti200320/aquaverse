...
<body>
    ...
    <div class="fish-container">
        <div class="box-container-2 single-product">
            <div class="box">
                <img src="plant30.jpg" id="productImg">
                <div class="small-img-row">
                    
                    <div class="small-img-col">
                        <img src="plant30.jpg" alt="" class="small-img">
                    </div>
                    <div class="small-img-col">
                        <img src="plant30A.jpg" alt="" class="small-img">
                    </div>

                    <div class="small-img-col">
                        <img src="plant30B.jpg" alt="" class="small-img">
                    </div>
                    
                    <div class="small-img-col">
                        <img src="plant30C.jpg" alt="" class="small-img">
                    </div>
                </div>
            </div>
            <div>
                <h4>Home / plant</h4>
                <h1> Salvinia natans</h1>
                <h4>Rs./Pair</h4>
                <input type="number" value="1">
                <a href="cart.jsp" class="btn"> Add to cart</a>
                <h3>Products Details <i class="fa fa-indent"></i></h3><br>
                <p>In India, we can sell Salvinia natans/ floating fern/floating water moss/water butterfly wings via online delivery systems to any states including Andhra Pradesh, Arunachal Pradesh, Assam, Bihar, Goa, Gujarat, Haryana, Himachal Pradesh, Jammu & Kashmir, Karnata, Uttar Pradesh, Uttarakhand, and West Bengal,etc.<br><em>Common Name: Floating Fern, Floating Moss, Water Butterfly Wing, Floating Water moss<br> Family Name: Salviniaceae<br> Genus: Salvinia<br> Species: natans</em><br>Sporocarps with micro- and macrosporangia are the organs of sexual reproduction. Each macrosporangium produces <b>32 spores</b>, only one of which survives<em>(macrospore 70?75 ?m in diameter)</em>, while the microsporangium contains<b> 64 microspores</b>, each about <em>20 ?m in diameter</em>. The macrospore develops into the female gametophyte, and the microspore into the male one</p>
            </div>
        </div>
    </div>
    <div class="fish-container">
