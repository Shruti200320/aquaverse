...
<body>
    ...
    <div class="fish-container">
        <div class="box-container-2 single-product">
            <div class="box">
                <img src="food1.jpg" id="productImg">
                <div class="small-img-row">
                    
                    <div class="small-img-col">
                        <img src="food1.jpg" alt="" class="small-img">
                    </div>
                    <div class="small-img-col">
                        <img src="food1A.jpg" alt="" class="small-img">
                    </div>

                    <div class="small-img-col">
                        <img src="food1B.jpg" alt="" class="small-img">
                    </div>
                    
                    <div class="small-img-col">
                        <img src="food1C.jpeg" alt="" class="small-img">
                    </div>
                </div>
            </div>
            <div>
                <h4>Home / foods</h4>
                <h1> Artemia Flakes</h1>
                <h4><em>Rs.179/(100 grams)</em></h4>
                <input type="number" value="1">
                <a href="cart.jsp" class="btn"> Add to cart</a>
                <h3>Products Details <i class="fa fa-indent"></i></h3><br>
                <p><b>Usage:</b> It is a superior quality flake food and it can be fed like any other flake foods in the aquarium industry.  Artemia flakes are excellent for all kinds of fishes as they contain all the essential nutrients for fishes and its crude protein is around 50%. We at Himadri provide this food for our Gold fishes, guppies, tetras, angels and almost all tropical fishes; and we recommend you to try this amazing food for your fishes as well.<br>
                In India, we can deliver this product to any state including Andhra Pradesh, Arunachal Pradesh, Assam, Bihar, Chhattisgarh, Goa, Gujarat, Haryana, Himachal Pradesh, Jammu & Kashmir, Jharkhand,etc.</p>
            </div>
        </div>
    </div>
    <div class="fish-container">
