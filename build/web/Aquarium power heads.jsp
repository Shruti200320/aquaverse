...
<body>
    ...
    <div class="fish-container">
        <div class="box-container-2 single-product">
            <div class="box">
                <img src="Acc 8.jpg" id="productImg">
                <div class="small-img-row">
                    
                    <div class="small-img-col">
                        <img src="Acc 8.jpg" alt="" class="small-img">
                    </div>
                    <div class="small-img-col">
                        <img src="acc8A.jpg" alt="" class="small-img">
                    </div>

                    <div class="small-img-col">
                        <img src="acc8B.jpg" alt="" class="small-img">
                    </div>  
                </div>
            </div>
            <div>
                <h4>Home / Accessories</h4>
                <h1> Aquarium power heads</h1>
                <h4><em>Rs.775</em></h4>
                <input type="number" value="1">
                <a href="cart.jsp" class="btn"> Add to cart</a>
                <h3>Products Details <i class="fa fa-indent"></i></h3><br>
                <p>Sobo super wave maker ideal water circulator / high performance low energy consumption / quick and easy maintenance imported excellent quality model no - wp-3880 ac 220-240v / 10w / f.Max 10000 l/h best result use both side each wave maker circulation pump for aquariums. Useful to re-crates natural currents in fresh water and marine aquariums. Compact size, adjustable direction of water flow. High performance with minimum power consumption. It can be easily mounted with its powerful suction cup, reliable, extremely silent and easy to maintain. Frequency - 50/60Hz, Watt - 35W.</p>
            </div>
        </div>
    </div>
    <div class="fish-container">
