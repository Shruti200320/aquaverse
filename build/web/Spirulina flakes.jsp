...
<body>
    ...
    <div class="fish-container">
        <div class="box-container-2 single-product">
            <div class="box">
                <img src="Food 8.jpg" id="productImg">
                <div class="small-img-row">
                    
                    <div class="small-img-col">
                        <img src="Food 8.jpg" alt="" class="small-img">
                    </div>
                    <div class="small-img-col">
                        <img src="food8A.jpeg" alt="" class="small-img">
                    </div>

                    <div class="small-img-col">
                        <img src="food8B.jpeg" alt="" class="small-img">
                    </div>
                    
                    <div class="small-img-col">
                        <img src="food8C.jpg" alt="" class="small-img">
                    </div>
                </div>
            </div>
            <div>
                <h4>Home / foods</h4>
                <h1> Spirulina Flakes</h1>
                <h4><em>Rs.150/(100 grams)</em></h4>
                <input type="number" value="1">
                <a href="cart.jsp" class="btn"> Add to cart</a>
                <h3>Products Details <i class="fa fa-indent"></i></h3><br>
                <p>In India, we can deliver this product to any state including Andhra Pradesh, Arunachal Pradesh, Assam, Bihar, Chhattisgarh, Goa, Gujarat, Haryana, Himachal Pradesh,etc.<br><em>This product added enzyme immune antibody, palatability better; Crunchy, digestion is fast, good absorption, no pollution Water quality. Contain a variety of vitamins, improve fish immunity, fish health; Including spirulina,The Antarctic shrimp, brightening effect fast, nutrition is higher than general. The use of advanced production technology at low temperature,Lock nutrition to ensure quality.</em><br><b><em>Method of use:</em></b> High nutritional formula feeding, please reduce 2-3 times a day, each feeding will be subject to 3-5 minutes</p>
            </div>
        </div>
    </div>
    <div class="fish-container">
