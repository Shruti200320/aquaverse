...
<body>
    ...
    <div class="fish-container">
        <div class="box-container-2 single-product">
            <div class="box">
                <img src="Acc 9.jpg" id="productImg">
                <div class="small-img-row">
                    
                    <div class="small-img-col">
                        <img src="Acc 9.jpg" alt="" class="small-img">
                    </div>
                    <div class="small-img-col">
                        <img src="acc9A.jpg" alt="" class="small-img">
                    </div>

                    <div class="small-img-col">
                        <img src="acc9B.jpg" alt="" class="small-img">
                    </div>  
                </div>
            </div>
            <div>
                <h4>Home / Accessories</h4>
                <h1> Schmick Pebbles for Decoration</h1>
                <h4><em>Rs.229/1 kg</em></h4>
                <input type="number" value="1">
                <a href="cart.jsp" class="btn"> Add to cart</a>
                <h3>Products Details <i class="fa fa-indent"></i></h3><br>
                <p> Good quality glossy colorful pebbles for decoration and home decor. <b>Size 15 to 25 mm</b>.<br>
                    These decorative stones and pebbles can be used to decorate home, plant pots, glass table, terrariums, flower vases, garden, candles, bowls, craft projects, floral arrangements, fountains and many more.<br>
                    These pebbles stones for decoration are ideal for indoor, outdoor, garden decoration. These decorative stones add lives and colors to walkways, flooring or walls.<br>
                    Schmick colourful stones and pebbles adds colour and vivid touch to your home, garden, plant pots, flower vase, table.<br>
                    Used For Decor Purpose At Hotels, Restaurants As Well As In Households, Perfect For Flooring, Shower Floors & Walls And Pools/Aquariums Etc.</p>
            </div>
        </div>
    </div>
    <div class="fish-container">
