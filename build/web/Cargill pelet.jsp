...
<body>
    ...
    <div class="fish-container">
        <div class="box-container-2 single-product">
            <div class="box">
                <img src="Food 2.jpeg" id="productImg">
                <div class="small-img-row">
                    
                    <div class="small-img-col">
                        <img src="Food 2.jpeg" alt="" class="small-img">
                    </div>
                    <div class="small-img-col">
                        <img src="food2A.jpg" alt="" class="small-img">
                    </div>

                    <div class="small-img-col">
                        <img src="food2B.jpg" alt="" class="small-img">
                    </div>
                    
                    <div class="small-img-col">
                        <img src="food2C.jpg" alt="" class="small-img">
                    </div>
                </div>
            </div>
            <div>
                <h4>Home / foods</h4>
                <h1> Cargill pellet</h1>
                <h4><em>Rs.59/(100 grams)</em></h4>
                <input type="number" value="1">
                <a href="cart.jsp" class="btn"> Add to cart</a>
                <h3>Products Details <i class="fa fa-indent"></i></h3><br>
                <em><b>Usage:</b> A direct feedable pellet food. Can be given to shrimps, snails, and any other tropical fishes.</em><br>
