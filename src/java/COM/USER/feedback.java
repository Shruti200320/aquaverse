...
public class feedback extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            String feedemail=request.getParameter("feedemail");
            String feeddes=request.getParameter("feeddes");
            ...
            try{
                ...
                ps.setString(2,feedemail);
                ps.setString(3,feeddes);
                ps.setString(4,rating);
                ps.executeUpdate();
                response.sendRedirect("feedconfirm.jsp");
            }
            catch(Exception e){
                out.println(e);
            }
