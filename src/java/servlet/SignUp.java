...
public class SignUp extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            String rphno=request.getParameter("phno");
            RequestDispatcher dispatcher=null;
            Connection con=null;
            try{
                Class.forName("com.mysql.jdbc.Driver");
                con=DriverManager.getConnection("jdbc:mysql://localhost:3306/server","root","T#9758@qlph");
                PreparedStatement ps=con.prepareStatement("insert into users(runame,rfullname,remail,rphno,rpass) values (?,?,?,?,?)");
                ps.setString(1,runame);
                ps.setString(2,rfullname);
                ps.setString(3,remail);
                ps.setString(4,rphno);
